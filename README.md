# 🎮 플레이 시스템 설계 경험을 보유한 Unity 클라이언트 개발자
---
## 👋 자기소개
안녕하세요. 저는 플레이어 경험에 직접적인 영향을 주는 시스템과 플레이 구조 설계를 강점으로 하는 Unity 개발자 최민준입니다.

3년간 Unity 기반 3D 프로젝트를 개발하며 캐릭터 조작, 상태 이상 시스템, 아이템 구조 등 게임의 핵심 시스템을 직접 설계하고 구현해 왔습니다. 단순 기능 구현을 넘어 유지보수와 확장성을 고려한 구조 설계를 지향하며, 실제 플레이 흐름 속에서 안정적으로 동작하는 시스템 개발에 집중하고 있습니다.
